...
def GetHoursWorked():
    hours = float(input('Enter hours employee worked: '))
    return hours
#write the GetHourlyRate function
def GetHourlyRate():
    hourlyrate = float(input('Enter employee hourly rate: '))
    return hourlyrate
# write the GetTaxRate function
def GetTaxRate():
    taxrate = float(input('Enter employee tax rate: '))
    return taxrate
...
def printinfo(empname, hours, hourlyrate,grosspay, taxrate, incometax, netpay):
    ...
    print('Gross Pay Amount: ', f'{grosspay:,.2f}')
    print('Tax Rate Amount: ', f'{taxrate:,.2%}')
    print('Income Tax Amount: ', f'{incometax:,.2f}')
    print('Net Pay Amount: ', f'{netpay:,.2f}')
